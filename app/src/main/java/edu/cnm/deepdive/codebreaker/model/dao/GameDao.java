...
public interface GameDao {
  ...
  @Insert
  Single<List<Long>> insert(Collection<Game> games);    /* Long is primary key value */
  ...
  @Delete
  Single<Integer> delete(Collection<Game> games);      /* Integer is number of games affected */
